...
Nav bar ด้านบนมี 4 หน้าพิเศษที่มากับระบบ (News, TH Energy, GlobalCPI, Dashboard v2) และหน้าที่ผู้ใช้สร้างเองได้ไม่จำกัด (ปุ่ม `+` ท้าย nav)
...
### 4. Dashboard v2
หน้าเหมือน Custom Pages ทุกประการ (การ์ดกราฟ เพิ่ม/ลบ series ที่ติดตามเองได้ผ่าน catalog เดิม 1–8 เส้นต่อการ์ด — ดูรายละเอียดฟีเจอร์ทั้งหมดในหัวข้อ "5. หน้าที่สร้างเอง" ด้านล่าง) ต่างกันแค่ปักหมุดเป็นปุ่ม nav แยกต่างหาก ไม่ต้องกด `+` สร้างเอง — เลือก series ได้เฉพาะที่อยู่ใน catalog ปกติ (BOT/TPSO/BIS/IMF GDP-FSI-CPI aggregate ฯลฯ) **ไม่รวม GlobalCPI** (IMF CPI รายประเทศ ถูกกันไว้ไม่ให้เลือกจากที่ไหนนอกหน้า GlobalCPI โดยเจตนา)
