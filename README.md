...
เปรียบเทียบเงินเฟ้อ (%YoY) รายประเทศจาก IMF CPI จัดเป็น 7 การ์ดตามกลุ่มเศรษฐกิจ: G7, EU, Other AE (Advanced Economies อื่นๆ นอกเหนือ G7/EU), Emerging Asia (Excl. ASEAN), ASEAN, Latin America, และ Other Countries (ประเทศที่มีข้อมูลแต่ไม่เข้ากลุ่มไหนเลย — คำนวณสดจากข้อมูลจริง ไม่ใช่รายชื่อ fix) — 1 เส้น = 1 ประเทศ ทุกเส้นเป็นสีเทาโดย default
...
- แกน Y แต่ละกราฟ autoscale ตามข้อมูลจริง แต่ clamp ไว้ไม่เกิน -5% ถึง 15% กันประเทศเงินเฟ้อสูงมากดึงสเกลจนเส้นอื่นแบนหาย
