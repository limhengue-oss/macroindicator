...
Nav bar ด้านบนมี 3 หน้าพิเศษที่มากับระบบ (News, TH Energy, GlobalCPI) และหน้าที่ผู้ใช้สร้างเองได้ไม่จำกัด (ปุ่ม `+` ท้าย nav)
...
เปรียบเทียบเงินเฟ้อ (%YoY) รายประเทศจาก IMF CPI จัดเป็น 4 การ์ดตามกลุ่มเศรษฐกิจ: Advanced Economies, Emerging Asia (Excl. ASEAN), ASEAN, Latin America — 1 เส้น = 1 ประเทศ ทุกเส้นเป็นสีเทาโดย default

- **Window** (มุมขวาบน): 1Y / 3Y / 10Y / 30Y ใช้ร่วมกันทั้ง 4 การ์ด
- **หมวดข้อมูล** (dropdown มุมขวาบน): headline (all items) หรือหมวดใดหมวดหนึ่งใน 13 หมวด COICOP ใช้ร่วมกันทั้ง 4 การ์ดเช่นกัน
- **Highlight ▾** (แต่ละการ์ด): ติ๊กเลือกประเทศที่อยากเน้น จะได้เส้นสีเด่นแยกจากเส้นเทาของประเทศอื่น
...
### 4. หน้าที่สร้างเอง (Custom Pages)
